...
const MasterLayout: FunctionComponent<PropsWithChildren> = ({ children }) => {
  return (
    <html
      lang='fa-IR'
      dir='rtl'
      className={clsx(FontIranYekanX.variable)}
      suppressHydrationWarning
    >
      <link rel='icon' href='/assets/splash_screens/icon512_rounded.png' />
