...
const PatientCreateView = (props: Props) => {
  ...
  async function onSubmit({
    ...
    try {
      ...
      toast.success("پرونده جدید ذخیره شد.");
      form.reset();
    } catch (error) {
  ...
  return (
    <PanelLayout className='w-full overflow-auto px-3 py-5'>
      ...
      <div className='px-5 flex flex-wrap justify-between w-full gap-x-2.5 gap-y-5'>
        <div className='flex flex-col gap-2.5 w-full md:w-5/12 items-center'>
          <Label>نام</Label>
          <span>
        ...
        <div className='flex flex-col gap-2.5 w-full md:w-11/12 items-center'>
        ...
        >
          ...
          <div className='px-2 w-full space-y-0 flex justify-between flex-wrap gap-x-2.5 gap-y-5 items-center'>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='space-y-2 flex flex-col gap-2.5 w-full md:w-5/12 items-start justify-between'>
          ...
          <div className='flex justify-end w-full mt-5'>
            <Button type='submit'>تشکیل پرونده</Button>
          </div>
        </form>
      </Form>
    </PanelLayout>
